...
def get_default_config():
    ...
    conf.lr = 1e-1
    # [9, 13, 15]
    conf.milestones = [2, 4, 8, 16, 18, 22, 24]#[9, 13, 15] #[10, 15, 22]  # down learing rate
    conf.gamma = 0.1
    conf.epochs = 25
    conf.momentum = 0.9
    conf.batch_size = 32
    ...
    # dataset
    conf.train_root_path = '/home/deepkaneria/dataset/class_3_extracted_v1_rec_lap_real_only_DoG_filtered_fixed_224'
...
def update_config(args, conf):
    ...
    conf.device = "cuda:{}".format(conf.devices[0])
    # conf.device = "cuda"
